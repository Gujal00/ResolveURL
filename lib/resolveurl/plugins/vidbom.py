...
class VidBomResolver(ResolveUrl):
    name = "vidbom"
    domains = ['vidbom.com', 'vidbem.com', 'vidbm.com', 'vedpom.com', 'vedbom.com', 'vedbom.org', 'vadbom.com',
               'myviid.com', 'myviid.net', 'myvid.com',
               'vidshare.com', 'vedsharr.com', 'vedshar.com', 'vedshare.com', 'vadshar.com']
    pattern = r'(?://|\.)((?:v[aie]d[bp][oe]?m|myvii?d|v[aei]dshar[er]?)\.(?:com|net|org))(?::\d+)?/(?:embed[/-])?([A-Za-z0-9]+)'
