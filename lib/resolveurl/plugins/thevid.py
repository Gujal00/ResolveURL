...
import resolveurl.plugins.thevid_gmu
from resolveurl import common
from resolveurl.resolver import ResolveUrl, ResolverError

logger = common.log_utils.Logger.get_logger(__name__)
logger.disable()
VID_SOURCE = r'https://raw.githubusercontent.com/jsergio123/script.module.resolveurl/master/lib/resolveurl/plugins/thevid_gmu.py'
...
class TheVidResolver(ResolveUrl):
    ...
    def get_media_url(self, host, media_id):
        try:
            ...
            reload_module(resolveurl.plugins.thevid_gmu)
            web_url = self.get_url(host, media_id)
            return resolveurl.plugins.thevid_gmu.get_media_url(web_url)
