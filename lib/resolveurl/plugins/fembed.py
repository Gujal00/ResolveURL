...
class FembedResolver(ResolveUrl):
    ...
    domains = ["fembed.com", "anime789.com", "24hd.club", "vcdn.io", "sharinglink.club", "votrefiles.club",
               ...
               "ncdnstm.com", "fembed-hd.com", "superplayxyz.club", "cinegrabber.com", "ndrama.xyz", "javstream.top"]
    pattern = r'(?://|\.)(' \
              ...
              r'diasfem|moviemaniac|albavido|ncdnstm|superplayxyz|cinegrabber|ndrama|javstream)\.' \
