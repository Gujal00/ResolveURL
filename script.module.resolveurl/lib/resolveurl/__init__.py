...
def _update_settings_xml():
    ...
    new_xml = [
        ...
        '\t\t<setting default="false" id="bp_enable" label="%s" type="bool"/>' % ('byparr_enable'),
        '\t\t<setting id="bp_url" visible="eq(-1,true)" enable="eq(-1,true)" type="text" label="%s" default="http://localhost:8191"/>' % ('byparr_url'),
        '\t\t<setting id="bp_timeout" visible="eq(-2,true)" enable="eq(-2,true)" type="slider" label="%s" default="60" range="30,30,180" option="int" />' % ('byparr_timeout'),
