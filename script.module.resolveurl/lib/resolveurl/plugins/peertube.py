...
class PeerTubeResolver(ResolveUrl):
    name = 'PeerTube'
    domains = ['peertube.tv', 'peertube.co.uk', 'peertube.uno', 'peertube.stream', 'video.doramed.tv']
    pattern = r'(?://|\.)(peertube\.(?:tv|co\.uk|uno|stream)|video\.doramed\.tv)/(?:videos/)?(?:embed|watch|w)/([0-9a-zA-Z-]+)'
