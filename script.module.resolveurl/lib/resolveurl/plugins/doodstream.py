...
class DoodStreamResolver(ResolveUrl):
    ...
    domains = [
        ...
        'all3do.com', 'do7go.com', 'doodcdn.io'
    ]
    pattern = r'(?://|\.)((?:do*0*o*0*ds?(?:tream|ter)?|ds2(?:play|video)|vidply|all3do|do7go|doodcdn)\.' \
              r'(?:com?|watch|to|s[ho]|cx|l[ai]|w[sf]|pm|re|yt|stream|pro|work|io))/(?:d|e)/([0-9a-zA-Z]+)'
