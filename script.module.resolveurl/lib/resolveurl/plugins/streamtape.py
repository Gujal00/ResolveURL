...
class StreamTapeResolver(ResolveUrl):
    ...
    domains = ['streamtape.com', 'strtape.cloud', 'streamtape.net', 'streamta.pe', 'streamtape.site',
               ...
               'streamadblockplus.com', 'shavetape.cash', 'streamtape.to', 'streamta.site', 'streamadblocker.xyz', 'tapewithadblock.org', 'adblocktape.wiki']
    pattern = r'(?://|\.)((?:s(?:tr)?(?:eam|have)?(?:ta?p?e?|cloud|adblock(?:plus|er))|tapewithadblock|adblocktape)\.' \
              r'(?:com|cloud|net|pe|site|link|cc|online|fun|cash|to|xyz|org|wiki))/(?:e|v)/([0-9a-zA-Z]+)'
