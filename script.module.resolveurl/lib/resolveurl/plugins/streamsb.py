...
class StreamSBResolver(ResolveUrl):
    ...
    domains = ['sbembed.com', 'sbembed1.com', 'sbplay.org', 'sbvideo.net', 'streamsb.net', 'sbplay.one',
               ...
               'embedtv.fun', 'sblongvu.com', 'arslanrocky.xyz']
    pattern = r'(?://|\.)(' \
              r'(?:view|watch|embed(?:tv)?|tube|player|cloudemb|japopav|javplaya|p1ayerjavseen|stream(?:ovies)?|vidmovie)?s{0,2}b?' \
              r'(?:embed\d?|play\d?|video|fast|full|streams{0,3}|the|speed|l?anh|tvmshow|longvu|arslanrocky)?\.(?:com|net|org|one|tv|xyz|fun))/' \
