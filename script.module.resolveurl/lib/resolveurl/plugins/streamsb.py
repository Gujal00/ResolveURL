...
class StreamSBResolver(ResolveUrl):
    ...
    pattern = r'(?://|\.)(' \
              r'(?:view|watch|embed(?:tv)?|tube|player|cloudemb|japopav|javplaya|p1ayerjavseen|gomovizplay|sbnmp|' \
              ...
              r'chill|rity|hight|brisk|face|lvturbo|net|one|asian|ani|rapid|sonic|lona|bar)?\.' \
