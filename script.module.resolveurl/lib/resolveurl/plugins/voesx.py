...
class VoeResolver(ResolveUrl):
    ...
    domains = ['voe.sx', 'voe-unblock.com', 'voe-unblock.net', 'voeunblock.com',
               ...
               'audaciousdefaulthouse.com', 'launchreliantcleaverriver.com', 'reputationsheriffkennethsand.com']
    domains += ['voeunblock{}.com'.format(x) for x in range(1, 11)]
    pattern = r'(?://|\.)((?:audaciousdefaulthouse|launchreliantcleaverriver|reputationsheriffkennethsand|' \
