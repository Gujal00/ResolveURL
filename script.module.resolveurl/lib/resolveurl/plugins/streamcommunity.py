...
class StreamCommunityResolver(ResolveUrl):
    ...
    domains = ['streamingcommunity.xyz', 'streamingcommunity.one', 'streamingcommunity.vip',
               ...
               'streamingcommunity.host', 'streamingcommunity.site']
    pattern = r'(?://|\.)(streamingcommunity\.(?:one|xyz|video|vip|work|name|live|tv|space|art|fun|website|host|site))/watch/(\d+(?:\?e=)?\d+)'
    ...
    def get_media_url(self, host, media_id):
        ...
        if match:
            ...
            headers.update({'Referer': 'https://streamingcommunity.site/'})
    ...
    def get_url(self, host, media_id):
        return self._default_get_url(host, media_id, template='https://streamingcommunity.site/watch/{media_id}')
