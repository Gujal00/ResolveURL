...
class StreamCommunityResolver(ResolveUrl):
    ...
    def get_url(self, host, media_id):
        return self._default_get_url(host, media_id, template='https://streamingcommunity.city/watch/{media_id}')
